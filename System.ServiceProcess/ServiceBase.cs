...
namespace System.ServiceProcess
{
    ...
    public class ServiceBase : Component 
    {
        ...
        private ExceptionDispatchInfo startFailedException;
        ...
        public static void Run (ServiceBase[] services) 
        {
            ...
            {
                if (service.startFailedException != null)
                {
                    ...
                    service.startFailedException.Throw ();
                }
            }
        ...
        private void ServiceQueuedMainCallback (object state) 
        {
            ...
            catch (Exception e) 
            {
                ...
                if (!LocalAppContextSwitches.DontThrowExceptionsOnStart)
                {
                    ...
                    startFailedException = ExceptionDispatchInfo.Capture (e);
                }
            }
        ...
        public unsafe void ServiceMainCallback (int argCount, IntPtr argPointer) 
        {
            fixed (NativeMethods.SERVICE_STATUS *pStatus = &status) 
            {
                ...
                if (startFailedException != null)
                {
                    ...
                    {
                        status.win32ExitCode = NativeMethods.ERROR_EXCEPTION_IN_SERVICE;
                    }
                }
