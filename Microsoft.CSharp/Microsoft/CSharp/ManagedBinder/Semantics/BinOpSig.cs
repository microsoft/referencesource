        ...
        protected class BinOpFullSig : BinOpSig
        {
            ...
            ***************************************************************************************************/
            public BinOpFullSig(ExpressionBinder fnc, BinOpSig bos)
            {
                ...
                this.type1 = pt1 != PredefinedType.PT_UNDEFINEDINDEX ? fnc.GetOptPDT(pt1) : null;
                this.type2 = pt2 != PredefinedType.PT_UNDEFINEDINDEX ? fnc.GetOptPDT(pt2) : null;
            ...
            public bool isLifted()
            {
                ...
                Debug.Assert(((grflt & LiftFlags.Lift1) == 0) || ((grflt & LiftFlags.Convert1) == 0));
                Debug.Assert(((grflt & LiftFlags.Lift2) == 0) || ((grflt & LiftFlags.Convert2) == 0));
