    ...
    internal partial class ExpressionBinder
    {
        ...
        */
        ...
        protected EXPR bindUserDefinedBinOp(ExpressionKind ek, BinOpArgInfo info)
        {
            ...
            {
                // REVIEW : What should we use as the cutoff?
                return null;
            }
                ...
                BinOpArgInfo info)
        {
            ...
            // CONSIDER: Do we need to loop over the whole list here, or just
            // CONSIDER: from 0 . bestSignature - 1?
        ...
        */
        public EXPR BindStandardBinop(ExpressionKind ek, EXPR arg1, EXPR arg2)
        {
            ...
            // UNDONE: Consider making this an accessor.
            info.mask = (BinOpMask)(1 << (int)info.binopKind);

            // REVIEW : What's the correct number to use?
        ...
        EXPR BindLiftedStandardBinOp(BinOpArgInfo info, BinOpFullSig bofs, ExpressionKind ek, EXPRFLAG flags)
        {
        ...
        void LiftArgument(EXPR pArgument, CType pParameterType, bool bConvertBeforeLift,
        ...
        */
        bool CanConvertArg1(BinOpArgInfo info, CType typeDst, out LiftFlags pgrflt,
        ...
        */
        bool CanConvertArg2(BinOpArgInfo info, CType typeDst, out LiftFlags pgrflt,
                                      out CType ptypeSig1, out CType ptypeSig2)
        {
            Debug.Assert(!typeDst.IsNullableType());
            ptypeSig1 = null;
        ...
        */
        void RecordBinOpSigFromArgs(List<BinOpFullSig> prgbofs, BinOpArgInfo info)
        {
            LiftFlags grflt = LiftFlags.None;
            CType typeSig1;
            CType typeSig2;
        ...
        */
        protected bool GetPtrBinOpSigs(List<BinOpFullSig> prgbofs, BinOpArgInfo info)
        {
            ...
            if (info.type1.IsPointerType())
            {
                ...
                for (uint i = 0; i < rgptIntOp.Length; i++)
                {
        ...
        */
        ...
        // UNDONE: It would be nice if this returned Neither, Left, Right rather than -1, 0, 1
        int WhichBofsIsBetter(BinOpFullSig bofs1, BinOpFullSig bofs2, CType type1, CType type2)
        {
            BetterType bt1;
            BetterType bt2;
        ...
        static bool CalculateExprAndUnaryOpKinds(
                OperatorKind op,
                bool bChecked,
        ...
        UnaryOperatorSignatureFindResult PopulateSignatureList(EXPR pArgument, UnaOpKind unaryOpKind, UnaOpMask unaryOpMask, ExpressionKind exprKind, EXPRFLAG flags, List<UnaOpFullSig> pSignatures, out EXPR ppResult)
        {
            ...
            if (ptRaw > PredefinedType.PT_ULONG)
            {
                ...
                else if (unaryOpKind == UnaOpKind.IncDec)
                {
                    ...
                    if (exprVal != null)
                    {
                        ...
                        {
                            // TODO: This seems like it can never be reached - exprVal is only valid if 
        ...
        EXPR BindLiftedStandardUnop(ExpressionKind ek, EXPRFLAG flags, EXPR arg, UnaOpFullSig uofs)
        {
        ...
        */
        int WhichUofsIsBetter(UnaOpFullSig uofs1, UnaOpFullSig uofs2, CType typeArg)
        {
            BetterType bt;
        ...
        */
        EXPR BindIntBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
        ...
        */
        EXPR BindIntUnaOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg)
        {
        ...
        */
        EXPR BindRealBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
            Debug.Assert(arg1.type.isPredefined() && arg2.type.isPredefined() && arg1.type.getPredefType() == arg2.type.getPredefType());
        ...
        */
        EXPR BindRealUnaOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg)
        {
            Debug.Assert(arg.type.isPredefined());
        ...
        */
        EXPR BindIncOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg, UnaOpFullSig uofs)
        {
        ...
        EXPR BindIncOpCore(ExpressionKind ek, EXPRFLAG flags, EXPR exprVal, CType type)
        {
            Debug.Assert(ek == ExpressionKind.EK_ADD || ek == ExpressionKind.EK_SUB);
        ...
        EXPRMULTI BindNonliftedIncOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg, UnaOpFullSig uofs)
        {
            Debug.Assert(ek == ExpressionKind.EK_ADD || ek == ExpressionKind.EK_SUB);
        ...
        EXPRMULTI BindLiftedIncOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg, UnaOpFullSig uofs)
        {
            Debug.Assert(ek == ExpressionKind.EK_ADD || ek == ExpressionKind.EK_SUB);
            Debug.Assert(uofs.isLifted());
        ...
        */
        EXPR BindDecBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
        ...
        LBothConst:
            ...
            switch (ek)
            {
                ...
                case ExpressionKind.EK_MOD:
                    {
                        // REVIEW : The decimal library should have % functionality. Computing it
                        // this way can overflow when % really doesn't need to.
        ...
        */
        EXPR BindDecUnaOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg)
        {
        ...
        */
        EXPR BindStrBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
        ...
        */
        EXPR BindShiftOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
        ...
        */
        EXPR BindBoolBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
            Debug.Assert(arg1 != null);
            Debug.Assert(arg2 != null);
        ...
        EXPR BindBoolBitwiseOp(ExpressionKind ek, EXPRFLAG flags, EXPR expr1, EXPR expr2, BinOpFullSig bofs)
        {
        ...
        EXPR BindLiftedBoolBitwiseOp(ExpressionKind ek, EXPRFLAG flags, EXPR expr1, EXPR expr2)
        {
            return null;
        }
        ...
        */
        EXPR BindBoolUnaOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg)
        {
        ...
        */
        EXPR BindStrCmpOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
        ...
        */
        EXPR BindRefCmpOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
            Debug.Assert(ek == ExpressionKind.EK_EQ || ek == ExpressionKind.EK_NE);
        ...
        */
        EXPR BindDelBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
        ...
        */
        EXPR BindEnumBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
        ...
        */
        EXPR BindEnumUnaOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg)
        {
        ...
        */
        EXPR BindPtrBinOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
            return null;
        }
        ...
        */
        EXPR BindPtrCmpOp(ExpressionKind ek, EXPRFLAG flags, EXPR arg1, EXPR arg2)
        {
            return null;
        }
        ...
        /*
            ...
            REVIEW : Use a lookup table of some sort. It'd work best if we had the OPERATOR instead
            of EXPRKIND.
        */
        bool GetBinopKindAndFlags(ExpressionKind ek, out BinOpKind pBinopKind, out EXPRFLAG flags)
        {
            flags = 0;
            switch (ek)
            {
        ...
        static bool isDivByZero(ExpressionKind kind, EXPR op2)
        {
            return false;
        }

        EXPR FoldIntegerConstants(ExpressionKind kind, EXPRFLAG flags, EXPR op1, EXPR op2, PredefinedType ptOp)
        {
        ...
        */
        EXPR BindIntOp(ExpressionKind kind, EXPRFLAG flags, EXPR op1, EXPR op2, PredefinedType ptOp)
        {
            //Debug.Assert(kind.isRelational() || kind.isArithmetic() || kind.isBitwise());
            Debug.Assert(ptOp == PredefinedType.PT_INT || ptOp == PredefinedType.PT_UINT || ptOp == PredefinedType.PT_LONG || ptOp == PredefinedType.PT_ULONG);
            CType typeOp = GetReqPDT(ptOp);
        ...
        EXPR BindIntegerNeg(EXPRFLAG flags, EXPR op, PredefinedType ptOp)
        {
        ...
        EXPR FoldConstI4Op(ExpressionKind kind, EXPR op1, EXPRCONSTANT opConst1, EXPR op2, EXPRCONSTANT opConst2, PredefinedType ptOp)
        {
        ...
        EXPR FoldConstI8Op(ExpressionKind kind, EXPR op1, EXPRCONSTANT opConst1, EXPR op2, EXPRCONSTANT opConst2, PredefinedType ptOp)
        {
...
#endif
        EXPR bindFloatOp(ExpressionKind kind, EXPRFLAG flags, EXPR op1, EXPR op2)
        {
...
#pragma warning( default : 4723 )
        ...
        EXPR bindStringConcat(EXPR op1, EXPR op2)
        {
         ...
         */
        EXPR ambiguousOperatorError(ExpressionKind ek, EXPR op1, EXPR op2)
        {
        ...
        EXPR BindUserBoolOp(ExpressionKind kind, EXPRCALL pCall)
        {
            ...
            Debug.Assert(pCall.GetOptionalArguments().asLIST().GetOptionalElement().type == typeRet);
            Debug.Assert(pCall.GetOptionalArguments().asLIST().GetOptionalNextListNode().type == typeRet);
        ...
        AggregateType GetUserDefinedBinopArgumentType(CType type)
        {
            for (; ; )
            {
        ...
        int GetUserDefinedBinopArgumentTypes(CType type1, CType type2, AggregateType[] rgats)
        {
            int cats = 0;
        ...
        bool UserDefinedBinaryOperatorCanBeLifted(ExpressionKind ek, MethodSymbol method, AggregateType ats,
            TypeArray Params)
        {
        ...
        bool UserDefinedBinaryOperatorIsApplicable(List<CandidateFunctionMember> candidateList,
        ...
        AggregateType GetApplicableUserDefinedBinaryOperatorCandidatesInBaseTypes(
            List<CandidateFunctionMember> candidateList, ExpressionKind ek, AggregateType type,
        ...
        EXPRCALL BindUDBinop(ExpressionKind ek, EXPR arg1, EXPR arg2, bool fDontLift, out MethPropWithInst ppmpwi)
        {
        ...
        EXPRCALL BindUDBinopCall(EXPR arg1, EXPR arg2, TypeArray Params, CType typeRet, MethPropWithInst mpwi)
        {
        ...
        EXPRCALL BindLiftedUDBinop(ExpressionKind ek, EXPR arg1, EXPR arg2, TypeArray Params, MethPropWithInst mpwi)
        {
            EXPR exprVal1 = arg1;
            EXPR exprVal2 = arg2;
            TypeArray paramsRaw;
        ...
        AggregateType GetEnumBinOpType(ExpressionKind ek, CType argType1, CType argType2, out AggregateType ppEnumType)
        {
        ...
        EXPRBINOP CreateBinopForPredefMethodCall(ExpressionKind ek, PREDEFMETH predefMeth, CType RetType, EXPR arg1, EXPR arg2)
        {
        ...
        EXPRUNARYOP CreateUnaryOpForPredefMethodCall(ExpressionKind ek, PREDEFMETH predefMeth, CType pRetType, EXPR pArg)
        {
            MethodSymbol methSym = GetSymbolLoader().getPredefinedMembers().GetMethod(predefMeth);
