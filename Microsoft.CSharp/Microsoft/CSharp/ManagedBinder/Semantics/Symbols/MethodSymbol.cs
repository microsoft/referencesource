...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    class MethodSymbol : MethodOrPropertySymbol
    {
        private MethodKindEnum methKind; // An extra bit to prevent sign-extension
        private bool inferenceMustFail; // Inference must fail if there are no type variables or if
        private bool checkedInfMustFail; // there is a type variable used in no parameter.

        private MethodSymbol m_convNext; // For linked list of conversion operators.
        private PropertySymbol m_prop;     // For property accessors, this is the PropertySymbol.
        private EventSymbol m_evt;     // For event accessors, this is the EventSymbol.
    ...
    class InterfaceImplementationMethodSymbol : MethodSymbol
    {
    }

    class IteratorFinallyMethodSymbol : MethodSymbol
    {
    }
}
