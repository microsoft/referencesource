...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    internal class SymbolLoader
    {
        ...
        // UNDONE:  It would be nice to make this a virtual method on typeSym.
        ...
        bool HasInterfaceConversion(AggregateType pSource, AggregateType pDest)
        {
        ...
        bool HasDelegateConversion(AggregateType pSource, AggregateType pDest)
        {
