...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    // Consider: distinguishing Constructor's from regular MethodCallingConventionEnum.Instance methods
    ...
    // Consider: adding bounds for type variables.
    ...
    internal class PredefinedMembers
    {
        ...
        private MethodSymbol[] m_methods = new MethodSymbol[(int)PREDEFMETH.PM_COUNT];
        private PropertySymbol[] m_properties = new PropertySymbol[(int)PREDEFPROP.PP_COUNT];
        ...
        private MethodSymbol FindDelegateConstructor(AggregateSymbol delegateType)
        {
            ...
            MethodSymbol ctor = FindDelegateConstructor(delegateType, g_DelegateCtorSignature1);
            if (ctor == null)
            {
                ctor = FindDelegateConstructor(delegateType, g_DelegateCtorSignature2);
            }
        ...
        public PredefinedMembers(SymbolLoader loader)
        {
            ...
            m_methods = new MethodSymbol[(int)PREDEFMETH.PM_COUNT];
            m_properties = new PropertySymbol[(int)PREDEFPROP.PP_COUNT];
        ...
        private static int[] g_DelegateCtorSignature1 = { (int)PredefinedType.PT_VOID, 2, (int)PredefinedType.PT_OBJECT, (int)PredefinedType.PT_INTPTR };
        private static int[] g_DelegateCtorSignature2 = { (int)PredefinedType.PT_VOID, 2, (int)PredefinedType.PT_OBJECT, (int)PredefinedType.PT_UINTPTR };
        ...
        private static PredefinedPropertyInfo[] g_predefinedProperties = {
        ...
        // UNDONE: use same enum in FieldSymbol definition
        ...
        private static PredefinedMethodInfo[] g_predefinedMethods = new PredefinedMethodInfo[(int)PREDEFMETH.PM_COUNT] {
            ...
            new PredefinedMethodInfo(   PREDEFMETH.PM_DELEGATE_CREATEDELEGATE_TYPE_OBJ_METHINFO,       MethodRequiredEnum.Optional,   PredefinedType.PT_DELEGATE,            PredefinedName.PN_CREATEDELEGATE,          MethodCallingConventionEnum.Static,     ACCESS.ACC_PUBLIC,     0,  new int[] { (int)PredefinedType.PT_DELEGATE, 3, (int)PredefinedType.PT_TYPE, (int)PredefinedType.PT_OBJECT, (int)PredefinedType.PT_METHODINFO  }),
