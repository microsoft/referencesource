...
{
    class CType : ITypeOrNamespace
    {
        private TypeKind m_typeKind;
        private Name m_pName;

        private bool fHasErrors;  // Whether anyituents have errors. This is immutable.
        private bool fUnres;      // Whether anyituents are unresolved. This is immutable.
        private bool isBogus;     // can't be used in our language -- unsupported type(s)
        private bool checkedBogus; // Have we checked a method args/return for bogus types
        ...
        { 
            return this.AssociatedSystemType.Attributes.HasFlag(System.Reflection.TypeAttributes.WindowsRuntime); 
        }

        public bool IsCollectionType()
        {
            if ((this.AssociatedSystemType.IsGenericType &&
                 (this.AssociatedSystemType.GetGenericTypeDefinition() == typeof(System.Collections.Generic.IList<>) ||
                  this.AssociatedSystemType.GetGenericTypeDefinition() == typeof(System.Collections.Generic.ICollection<>) ||
                  this.AssociatedSystemType.GetGenericTypeDefinition() == typeof(System.Collections.Generic.IEnumerable<>) ||
                  this.AssociatedSystemType.GetGenericTypeDefinition() == typeof(System.Collections.Generic.IReadOnlyList<>) ||
                  this.AssociatedSystemType.GetGenericTypeDefinition() == typeof(System.Collections.Generic.IReadOnlyCollection<>) ||
                  this.AssociatedSystemType.GetGenericTypeDefinition() == typeof(System.Collections.Generic.IDictionary<,>) ||
                  this.AssociatedSystemType.GetGenericTypeDefinition() == typeof(System.Collections.Generic.IReadOnlyDictionary<,>))) ||
        ...
        public TypeKind GetTypeKind() { return m_typeKind; }
        public void SetTypeKind(TypeKind kind) { m_typeKind = kind; }

        public Name GetName() { return m_pName; }
        public void SetName(Name pName) { m_pName = pName; }

        public bool checkBogus() { return isBogus; }
        public bool getBogus() { return isBogus; }
        public bool hasBogus() { return checkedBogus; }
        ...
        public bool isSpecialByRefType()
        {
            if (this == null)
                ...
                return this.getPredefType() == PredefinedType.PT_REFANY
#if !SILVERLIGHT
                       || this.getPredefType() == PredefinedType.PT_ARGITERATOR
#endif
                       || this.getPredefType() == PredefinedType.PT_ARGUMENTHANDLE;
            else
                return false;
        }
