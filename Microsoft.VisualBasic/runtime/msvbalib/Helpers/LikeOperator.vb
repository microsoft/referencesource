...
#If TELESTO Then
            'There is no operating system support for doing the katakana, full/half width mapping on Telesto. 
            'Telesto works cross platform (MAC) so we can't use LCMapString() as per below, anyway.
            'Our attempt at normalization will be simply to lower case the string.  This means we don't have the same 
            'behavior as the desktop for Japan.
        ...
        ( _
            ...
            Do While PGIndex > 0
                Select Case PatternGroups(PGIndex).PatType
                    ...
                    Case Else
#If TELESTO Then
                        Debug.Assert(False, "Unexpected pattern kind!!!") ' Silverlight CLR does not have Debug.Fail.
#Else
