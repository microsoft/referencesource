...
#If TELESTO Then
    Public NotInheritable Class Conversions 'FIXME: <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)> 
#Else
...
#If TELESTO Then
                If System.String.Compare(Value, Boolean.FalseString, loc, CompareOptions.IgnoreCase) = 0 Then
#Else
                If System.String.Compare(Value, Boolean.FalseString, True, loc) = 0 Then
#End If
                    Return False
#If TELESTO Then
                ElseIf System.String.Compare(Value, Boolean.TrueString, loc, CompareOptions.IgnoreCase) = 0 Then
#Else
...
#If Not TELESTO Then
                    ' This demand was added to fix an FxCop violation VSWhidbey 348449.
                    ' Silverlight uses Transparency Security model, 
                    ' - ReflectionPermission is not available
                    ' - Activator.CreateInstance is marked with SecuritySafeCritical
                    ...
                    If InvocationResult IsNot Nothing Then
                        ...
                        If Not _
                           (TargetType.IsGenericType AndAlso _
                            ...
                            TargetType.GetGenericArguments().Length > 0 AndAlso _
...
#If LATEBINDING And TELESTO Then
    Public NotInheritable Class LateBinderConversions
        Public Shared Function ChangeType(ByVal Expression As Object, ByVal TargetType As System.Type) As Object
