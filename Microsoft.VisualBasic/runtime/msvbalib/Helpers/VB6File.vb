...
SkipWhiteSpaceExit:
        ...
        ': The deal here is that this function was moved from vb6randomfile.vb to fix VSWhidbey 32408.  The problem is, it introduced a breaking change.  The bug this fix
        ...
        ': ValidateWriteable is not used anywhere - FxCop violation.
