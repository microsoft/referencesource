//------------------------------------------------------------------------------
// <copyright file="ConfigurationOptions.cs" company="Microsoft">
...
namespace System.Windows.Forms
{
    ...
    /// <summary>
    /// Microsoft application configuration options
    /// </summary>
    internal static class ConfigurationOptions
    {
        ...
        /// <summary>
        /// Extract value of the key specified from collection read from app.config file's Microsoft section
        /// </summary>
