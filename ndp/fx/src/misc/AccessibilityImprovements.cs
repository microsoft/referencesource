...
#elif DATAVISUALIZATION_NAMESPACE
    using Windows.Forms.DataVisualization.Charting;
#endif
...
#elif DATAVISUALIZATION_NAMESPACE
                throw new NotSupportedException(Windows.Forms.DataVisualization.Charting.SR.CombinationOfAccessibilitySwitchesNotSupported);
#else
...
#elif DATAVISUALIZATION_NAMESPACE
                throw new NotSupportedException(Windows.Forms.DataVisualization.Charting.SR.KeyboardToolTipDisplayBehaviorRequiresAccessibilityImprovementsLevel3);
#else
