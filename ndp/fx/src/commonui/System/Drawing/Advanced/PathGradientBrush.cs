...
namespace System.Drawing.Drawing2D {
    ...
    public sealed class PathGradientBrush : Brush {
        ...
        private void _SetSurroundColors(Color[] colors)
        {
            ...
            status = SafeNativeMethods.Gdip.GdipSetPathGradientSurroundColorsWithCount(new HandleRef(this, this.NativeBrush), 
                                                                        argbs,
                                                                        ref count);
        ...
        private Color[] _GetSurroundColors()
        {
            ...
            status = SafeNativeMethods.Gdip.GdipGetPathGradientSurroundColorsWithCount(new HandleRef(this, this.NativeBrush),
                                                                        argbs,
                                                                        ref count);
       ...
       /**
        ...
        private void _SetInterpolationColors(ColorBlend blend) {
            ...
            try {
                ...
                int status = SafeNativeMethods.Gdip.GdipSetPathGradientPresetBlend(new HandleRef(this, this.NativeBrush), new HandleRef(null, colors), new HandleRef(null, positions), count);
        ...
        private void _SetWrapMode(WrapMode wrapMode) {
            int status = SafeNativeMethods.Gdip.GdipSetPathGradientWrapMode(new HandleRef(this, this.NativeBrush), unchecked((int) wrapMode));
