...
namespace System.Threading
{
    ...
    public sealed class CancellationTokenSource : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            if (m_kernelEvent != null)
            {
                m_kernelEvent.Dispose(); // the critical cleanup to release an OS handle
        ...
        {
            if (m_disposed)
                throw new ObjectDisposedException(null, Strings.CancellationTokenSource_Disposed);
        }
            ...
            Action<object> callback, object stateForCallback, SynchronizationContext targetSyncContext)
        {
            ...
            if (!IsCancellationRequested)
            {
                ...
                CancellationCallbackInfo callbackInfo = new CancellationCallbackInfo(callback, stateForCallback, targetSyncContext, this);
...
#pragma warning restore 0618
        ...
        private void CancellationCallbackCoreWork_OnSyncContext(object obj)
        {
            ...
            {
                if (callback.TargetSyncContext != null)
                {
        ...
        public static CancellationTokenSource CreateLinkedTokenSource(params CancellationToken[] tokens)
        {
            ...
            if (tokens.Length == 0)
                throw new ArgumentException(Strings.CancellationToken_CreateLinkedToken_TokensIsEmpty, "tokens");
