...
namespace System.Threading.Tasks
{
    ...
    public class TaskCanceledException : OperationCanceledException
    {
        ...
        /// </summary>
        public TaskCanceledException() : base(Strings.TaskCanceledException_ctor_DefaultMessage)
        {
        }
        ...
        public TaskCanceledException(Task task) :
            base(Strings.TaskCanceledException_ctor_DefaultMessage, task!=null ? task.CancellationToken:new CancellationToken())
        {
            m_canceledTask = task;
        }
