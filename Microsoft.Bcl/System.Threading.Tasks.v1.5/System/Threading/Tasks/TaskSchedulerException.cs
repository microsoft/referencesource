...
namespace System.Threading.Tasks
{
    ...
    public class TaskSchedulerException : Exception
    {
        ...
        /// </summary>
        public TaskSchedulerException() : base(Strings.TaskSchedulerException_ctor_DefaultMessage) // 
        {
        }
        ...
        public TaskSchedulerException(Exception innerException)
            : base(Strings.TaskSchedulerException_ctor_DefaultMessage, innerException)
        {
        }
