...
namespace System.Threading
{
    ...
    public struct CancellationToken
    {
        ...
        private static Action<Object> s_ActionToActionObjShunt = new Action<Object>(ActionToActionObjShunt);
        ...
        private CancellationTokenRegistration Register(Action<Object> callback, Object state, bool useSynchronizationContext, bool useExecutionContext)
        {
            ...
            return m_source.InternalRegister(callback, state, capturedSyncContext);
        }
        ...
        public void ThrowIfCancellationRequested()
        {
            if (IsCancellationRequested)
                throw new OperationCanceledException(Strings.OperationCanceled, this);
        }
        ...
        internal void ThrowIfSourceDisposed()
        {
            ...
            {
                throw new ObjectDisposedException(null, Strings.CancellationToken_SourceDisposed);
            }
        }
