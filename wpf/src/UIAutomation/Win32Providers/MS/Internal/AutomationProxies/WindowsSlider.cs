//---------------------------------------------------------------------------
//
// <copyright file="WindowsSlider.cs" company="Microsoft">
    ...
    class WindowsSlider: ProxyHwnd, IRangeValueProvider
    {
        ...
        class SliderItem: ProxySimple, IInvokeProvider
        {
            ...
            private STID [] _asNames = {
                STID.LocalizedNameWindowsSliderItemBackByLargeAmount,
                STID.LocalizedNameWindowsSliderItemThumb,
                STID.LocalizedNameWindowsSliderItemForwardByLargeAmount
            };
