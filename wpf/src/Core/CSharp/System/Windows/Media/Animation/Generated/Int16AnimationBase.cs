//---------------------------------------------------------------------------
//
// <copyright file="Int16AnimationBase.cs" company="Microsoft">
...
{       
    ...
    public abstract class Int16AnimationBase : AnimationTimeline
    {
        ...
        /// <Summary>
        /// Creates a new Int16AnimationBase.
        /// </Summary>
        ...
        /// <summary>
        /// Creates a copy of this Int16AnimationBase
        /// </summary>
        ...
        /// The value this animation believes should be the current value for the property.
        /// </returns>
        public Int16 GetCurrentValue(Int16 defaultOriginValue, Int16 defaultDestinationValue, AnimationClock animationClock)
        {
            ReadPreamble();
            ...
            /*
            if (!AnimatedTypeHelpers.IsValidAnimationValueInt16(defaultDestinationValue))
            {
