//---------------------------------------------------------------------------
//
// <copyright file="DecimalAnimationUsingKeyFrames.cs" company="Microsoft">
...
{
    /// <summary>
    /// This class is used to animate a Decimal property value along a set
    /// of key frames.
    /// </summary>
    ...
    public class DecimalAnimationUsingKeyFrames : DecimalAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameDecimalAnimation.
        /// </Summary>
        ...
        {    
            ...
            if (sourceAnimation._keyFrames != null)
            {
                ...
                {
                    _keyFrames = (DecimalKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
                }
                else
                {
                    _keyFrames = (DecimalKeyFrameCollection)sourceAnimation._keyFrames.Clone();
                }
        ...
        /// </returns>
        protected sealed override Decimal GetCurrentValueCore(
            Decimal defaultOriginValue,
            Decimal defaultDestinationValue, 
            AnimationClock animationClock)
        {
            ...
            else
            {
                ...
                if (currentResolvedKeyFrameIndex == 0)
                {
                    ...
                    if (IsAdditive)
                    {
                        fromValue = AnimatedTypeHelpers.GetZeroValueDecimal(defaultOriginValue);
                    }
                    else
                    {
            ...
            if (IsCumulative)
            {
                ...
                {
                    currentIterationValue = AnimatedTypeHelpers.AddDecimal(
                        currentIterationValue,
                        AnimatedTypeHelpers.ScaleDecimal(GetResolvedKeyFrameValue(maxKeyFrameIndex), currentRepeat));
                }
            }
            ...
            if (IsAdditive)
            {                
                return AnimatedTypeHelpers.AddDecimal(defaultOriginValue, currentIterationValue);
            }
        ...
        /// <summary>
        /// Returns the DecimalKeyFrameCollection used by this KeyFrameDecimalAnimation.
        /// </summary>
        IList IKeyFrameAnimation.KeyFrames
        {
            ...
            set
            {
                KeyFrames = (DecimalKeyFrameCollection)value;
            }
        }
        ...
        public DecimalKeyFrameCollection KeyFrames
        {
            get
            {
                ...
                if (_keyFrames == null)
                {
                    if (this.IsFrozen)
                    {
                        _keyFrames = DecimalKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();

                        _keyFrames = new DecimalKeyFrameCollection();
        ...
        /// 0.0 there is slightly different behavior between KeyFrameDecimalAnimations
        ...
        private Decimal GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private DecimalKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        {
            Debug.Assert(!_areKeyTimesValid, "KeyFrameDecimalAnimaton.ResolveKeyTimes() shouldn't be called if the key times are already valid.");
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    Decimal prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        Decimal currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length.
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthDecimal(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthDecimal(prevKeyValue, _keyFrames[index].Value);
