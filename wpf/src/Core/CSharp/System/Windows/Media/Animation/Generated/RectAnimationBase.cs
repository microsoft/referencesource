//---------------------------------------------------------------------------
//
// <copyright file="RectAnimationBase.cs" company="Microsoft">
...
{       
    ...
    public abstract class RectAnimationBase : AnimationTimeline
    {
        ...
        /// <Summary>
        /// Creates a new RectAnimationBase.
        /// </Summary>
        ...
        /// <summary>
        /// Creates a copy of this RectAnimationBase
        /// </summary>
        ...
        public Rect GetCurrentValue(Rect defaultOriginValue, Rect defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            /*
            if (!AnimatedTypeHelpers.IsValidAnimationValueRect(defaultDestinationValue))
            {
