//---------------------------------------------------------------------------
//
// <copyright file="VectorAnimationUsingKeyFrames.cs" company="Microsoft">
...
{
    /// <summary>
    /// This class is used to animate a Vector property value along a set
    /// of key frames.
    /// </summary>
    ...
    public class VectorAnimationUsingKeyFrames : VectorAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameVectorAnimation.
        /// </Summary>
        ...
        /// </returns>
        protected sealed override Vector GetCurrentValueCore(
            ...
            AnimationClock animationClock)
        {
            ...
            else
            {
                ...
                if (currentResolvedKeyFrameIndex == 0)
                {
                    ...
                    if (IsAdditive)
                    {
                        fromValue = AnimatedTypeHelpers.GetZeroValueVector(defaultOriginValue);
                    }
                    else
                    {
            ...
            if (IsCumulative)
            {
                ...
                {
                    currentIterationValue = AnimatedTypeHelpers.AddVector(
                        currentIterationValue,
                        AnimatedTypeHelpers.ScaleVector(GetResolvedKeyFrameValue(maxKeyFrameIndex), currentRepeat));
                }
            }
            ...
            if (IsAdditive)
            {                
                return AnimatedTypeHelpers.AddVector(defaultOriginValue, currentIterationValue);
            }
        ...
        /// <summary>
        /// Returns the VectorKeyFrameCollection used by this KeyFrameVectorAnimation.
        /// </summary>
        IList IKeyFrameAnimation.KeyFrames
        {
            ...
            set
            {
                KeyFrames = (VectorKeyFrameCollection)value;
            }
        }
        ...
        public VectorKeyFrameCollection KeyFrames
        {
            get
            {
                ...
                if (_keyFrames == null)
                {
                    if (this.IsFrozen)
                    {
                        _keyFrames = VectorKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();

                        _keyFrames = new VectorKeyFrameCollection();
        ...
        private Vector GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private VectorKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    Vector prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        Vector currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length.
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthVector(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthVector(prevKeyValue, _keyFrames[index].Value);
