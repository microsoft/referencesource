//---------------------------------------------------------------------------
//
// <copyright file="Vector3DAnimationUsingKeyFrames.cs" company="Microsoft">
...
{
    /// <summary>
    /// This class is used to animate a Vector3D property value along a set
    /// of key frames.
    /// </summary>
    ...
    public class Vector3DAnimationUsingKeyFrames : Vector3DAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameVector3DAnimation.
        /// </Summary>
        ...
        {    
            ...
            if (sourceAnimation._keyFrames != null)
            {
                ...
                {
                    _keyFrames = (Vector3DKeyFrameCollection)sourceAnimation._keyFrames.Clone();
                }
        ...
        /// </returns>
        protected sealed override Vector3D GetCurrentValueCore(
            ...
            AnimationClock animationClock)
        {
            ...
            Vector3D currentIterationValue;
            ...
            else
            {
                ...
                if (currentResolvedKeyFrameIndex == 0)
                {
                    ...
                    if (IsAdditive)
                    {
                        fromValue = AnimatedTypeHelpers.GetZeroValueVector3D(defaultOriginValue);
                    }
                    else
                    {
            ...
            if (IsCumulative)
            {
                ...
                {
                    currentIterationValue = AnimatedTypeHelpers.AddVector3D(
                        currentIterationValue,
                        AnimatedTypeHelpers.ScaleVector3D(GetResolvedKeyFrameValue(maxKeyFrameIndex), currentRepeat));
                }
            }
            ...
            if (IsAdditive)
            {                
                return AnimatedTypeHelpers.AddVector3D(defaultOriginValue, currentIterationValue);
            }
        ...
        /// <summary>
        /// Returns the Vector3DKeyFrameCollection used by this KeyFrameVector3DAnimation.
        /// </summary>
        ...
        /// 0.0 there is slightly different behavior between KeyFrameVector3DAnimations
        ...
        private Vector3D GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private Vector3DKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        {
            Debug.Assert(!_areKeyTimesValid, "KeyFrameVector3DAnimaton.ResolveKeyTimes() shouldn't be called if the key times are already valid.");
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    Vector3D prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        Vector3D currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length.
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthVector3D(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthVector3D(prevKeyValue, _keyFrames[index].Value);
