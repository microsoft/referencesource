//---------------------------------------------------------------------------
//
// <copyright file="CharAnimationBase.cs" company="Microsoft">
...
{       
    ...
    public abstract class CharAnimationBase : AnimationTimeline
    {
        ...
        /// <Summary>
        /// Creates a new CharAnimationBase.
        /// </Summary>
        ...
        /// <summary>
        /// Creates a copy of this CharAnimationBase
        /// </summary>
        /// <returns>The copy</returns>
        public new CharAnimationBase Clone()
        {
            return (CharAnimationBase)base.Clone();
        }
        ...
        public Char GetCurrentValue(Char defaultOriginValue, Char defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            /*
            if (!AnimatedTypeHelpers.IsValidAnimationValueChar(defaultDestinationValue))
            {
