//---------------------------------------------------------------------------
//
// <copyright file="PointAnimation.cs" company="Microsoft">
...
{       
        ...
        PointAnimationBase
    {
        ...
        /// <summary>
        /// Static ctor for PointAnimation establishes
        /// dependency properties, using as much shared data as possible.
        /// </summary>
        static PointAnimation()
        {
            Type typeofProp = typeof(Point?);
            Type typeofThis = typeof(PointAnimation);
            ...
            FromProperty = DependencyProperty.Register(
                ...
                typeofProp,
                typeofThis,
                new PropertyMetadata((Point?)null, propCallback),
                validateCallback);
        ...
        /// <summary>
        /// Creates a new PointAnimation with all properties set to
        ...
        /// Point property from its base value to the value specified
        ...
        {
            PointAnimation a = (PointAnimation)d;
        ...
        private static bool ValidateFromToOrByValue(object value)
        {
            ...
            {
                return AnimatedTypeHelpers.IsValidAnimationValuePoint(typedValue.Value);
            }
            else
            {
                return true;
