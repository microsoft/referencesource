//---------------------------------------------------------------------------
//
// <copyright file="MatrixAnimationUsingKeyFrames.cs" company="Microsoft">
...
{
    /// <summary>
    /// This class is used to animate a Matrix property value along a set
    /// of key frames.
    /// </summary>
    ...
    public class MatrixAnimationUsingKeyFrames : MatrixAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameMatrixAnimation.
        /// </Summary>
        ...
        {    
            ...
            if (sourceAnimation._keyFrames != null)
            {
                ...
                {
                    _keyFrames = (MatrixKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
                }
                else
                {
                    _keyFrames = (MatrixKeyFrameCollection)sourceAnimation._keyFrames.Clone();
                }
        ...
        /// </returns>
        protected sealed override Matrix GetCurrentValueCore(
            Matrix defaultOriginValue,
            Matrix defaultDestinationValue, 
        ...
        /// <summary>
        /// Returns the MatrixKeyFrameCollection used by this KeyFrameMatrixAnimation.
        /// </summary>
        IList IKeyFrameAnimation.KeyFrames
        {
            ...
            set
            {
                KeyFrames = (MatrixKeyFrameCollection)value;
            }
        }
        ...
        public MatrixKeyFrameCollection KeyFrames
        {
            get
            {
                ...
                if (_keyFrames == null)
                {
                    if (this.IsFrozen)
                    {
                        _keyFrames = MatrixKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();

                        _keyFrames = new MatrixKeyFrameCollection();
        ...
        private Matrix GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private MatrixKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        {
            Debug.Assert(!_areKeyTimesValid, "KeyFrameMatrixAnimaton.ResolveKeyTimes() shouldn't be called if the key times are already valid.");
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    Matrix prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        Matrix currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length.
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthMatrix(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthMatrix(prevKeyValue, _keyFrames[index].Value);
