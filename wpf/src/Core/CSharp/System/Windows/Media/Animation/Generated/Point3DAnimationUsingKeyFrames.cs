//---------------------------------------------------------------------------
//
// <copyright file="Point3DAnimationUsingKeyFrames.cs" company="Microsoft">
...
{
    /// <summary>
    /// This class is used to animate a Point3D property value along a set
    /// of key frames.
    /// </summary>
    ...
    public class Point3DAnimationUsingKeyFrames : Point3DAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFramePoint3DAnimation.
        /// </Summary>
        ...
        /// <summary>
        /// Creates a copy of this KeyFramePoint3DAnimation.
        /// </summary>
        ...
        /// </returns>
        protected sealed override Point3D GetCurrentValueCore(
            ...
            AnimationClock animationClock)
        {
            ...
            else
            {
                ...
                if (currentResolvedKeyFrameIndex == 0)
                {
                    ...
                    if (IsAdditive)
                    {
                        fromValue = AnimatedTypeHelpers.GetZeroValuePoint3D(defaultOriginValue);
                    }
                    else
                    {
            ...
            if (IsCumulative)
            {
                ...
                {
                    currentIterationValue = AnimatedTypeHelpers.AddPoint3D(
                        currentIterationValue,
                        AnimatedTypeHelpers.ScalePoint3D(GetResolvedKeyFrameValue(maxKeyFrameIndex), currentRepeat));
                }
            }
            ...
            if (IsAdditive)
            {                
                return AnimatedTypeHelpers.AddPoint3D(defaultOriginValue, currentIterationValue);
            }
        ...
        /// <summary>
        /// Returns the Point3DKeyFrameCollection used by this KeyFramePoint3DAnimation.
        /// </summary>
        IList IKeyFrameAnimation.KeyFrames
        {
            ...
            set
            {
                KeyFrames = (Point3DKeyFrameCollection)value;
            }
        }
        ...
        public Point3DKeyFrameCollection KeyFrames
        {
            get
            {
                ...
                if (_keyFrames == null)
                {
                    if (this.IsFrozen)
                    {
                        _keyFrames = Point3DKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();

                        _keyFrames = new Point3DKeyFrameCollection();
        ...
        /// 0.0 there is slightly different behavior between KeyFramePoint3DAnimations
        ...
        private Point3D GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private Point3DKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    Point3D prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        Point3D currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length.
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthPoint3D(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthPoint3D(prevKeyValue, _keyFrames[index].Value);
