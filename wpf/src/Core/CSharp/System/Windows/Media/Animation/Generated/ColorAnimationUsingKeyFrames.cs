//---------------------------------------------------------------------------
//
// <copyright file="ColorAnimationUsingKeyFrames.cs" company="Microsoft">
...
namespace System.Windows.Media.Animation
{
    ...
    public class ColorAnimationUsingKeyFrames : ColorAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameColorAnimation.
        /// </Summary>
        ...
        /// <summary>
        /// Returns the ColorKeyFrameCollection used by this KeyFrameColorAnimation.
        /// </summary>
        IList IKeyFrameAnimation.KeyFrames
        {
            ...
            set
            {
                KeyFrames = (ColorKeyFrameCollection)value;
            }
        }
        ...
        public ColorKeyFrameCollection KeyFrames
        {
            get
            {
                ...
                if (_keyFrames == null)
                {
                    if (this.IsFrozen)
                    {
                        _keyFrames = ColorKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();
        ...
        /// 0.0 there is slightly different behavior between KeyFrameColorAnimations
        ...
        private Color GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private ColorKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
