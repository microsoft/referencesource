//---------------------------------------------------------------------------
//
// <copyright file="Rotation3DAnimationUsingKeyFrames.cs" company="Microsoft">
...
{
    /// <summary>
    /// This class is used to animate a Rotation3D property value along a set
    /// of key frames.
    /// </summary>
    ...
    public class Rotation3DAnimationUsingKeyFrames : Rotation3DAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameRotation3DAnimation.
        /// </Summary>
        ...
        /// <summary>
        /// Creates a copy of this KeyFrameRotation3DAnimation.
        /// </summary>
        ...
        #region Rotation3DAnimationBase
        ...
        /// <summary>
        /// Returns the Rotation3DKeyFrameCollection used by this KeyFrameRotation3DAnimation.
        /// </summary>
        ...
        /// 0.0 there is slightly different behavior between KeyFrameRotation3DAnimations
        ...
        private Rotation3D GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private Rotation3DKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        {
            Debug.Assert(!_areKeyTimesValid, "KeyFrameRotation3DAnimaton.ResolveKeyTimes() shouldn't be called if the key times are already valid.");
