//---------------------------------------------------------------------------
//
// <copyright file="BooleanAnimationUsingKeyFrames.cs" company="Microsoft">
...
namespace System.Windows.Media.Animation
{
    ...
    public class BooleanAnimationUsingKeyFrames : BooleanAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameBooleanAnimation.
        /// </Summary>
        ...
        {    
            ...
            if (sourceAnimation._keyFrames != null)
            {
                ...
                {
                    _keyFrames = (BooleanKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
                }
                else
                {
                    _keyFrames = (BooleanKeyFrameCollection)sourceAnimation._keyFrames.Clone();
                }
        ...
        /// </returns>
        protected sealed override Boolean GetCurrentValueCore(
            Boolean defaultOriginValue,
            Boolean defaultDestinationValue, 
        ...
        /// <summary>
        /// Returns the BooleanKeyFrameCollection used by this KeyFrameBooleanAnimation.
        /// </summary>
        IList IKeyFrameAnimation.KeyFrames
        {
            ...
            set
            {
                KeyFrames = (BooleanKeyFrameCollection)value;
            }
        }
        ...
        public BooleanKeyFrameCollection KeyFrames
        {
            get
            {
                ...
                if (_keyFrames == null)
                {
                    if (this.IsFrozen)
                    {
                        _keyFrames = BooleanKeyFrameCollection.Empty;
                    }
                    else
                    {
                        WritePreamble();
        ...
        private Boolean GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private BooleanKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        {
            Debug.Assert(!_areKeyTimesValid, "KeyFrameBooleanAnimaton.ResolveKeyTimes() shouldn't be called if the key times are already valid.");
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    Boolean prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        Boolean currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length.
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthBoolean(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthBoolean(prevKeyValue, _keyFrames[index].Value);
