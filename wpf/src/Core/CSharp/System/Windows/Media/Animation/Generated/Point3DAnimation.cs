//---------------------------------------------------------------------------
//
// <copyright file="Point3DAnimation.cs" company="Microsoft">
...
{       
    ...
    /// </summary>
    public partial class Point3DAnimation : 
        Point3DAnimationBase
    {
        ...
        /// <summary>
        /// Static ctor for Point3DAnimation establishes
        /// dependency properties, using as much shared data as possible.
        /// </summary>
        static Point3DAnimation()
        {
            Type typeofProp = typeof(Point3D?);
            Type typeofThis = typeof(Point3DAnimation);
            ...
            FromProperty = DependencyProperty.Register(
                ...
                typeofProp,
                typeofThis,
                new PropertyMetadata((Point3D?)null, propCallback),
                validateCallback);
        ...
        /// <summary>
        /// Creates a new Point3DAnimation with all properties set to
        ...
        /// Point3D property from its base value to the value specified
        ...
        /// <summary>
        /// Creates a copy of this Point3DAnimation
        /// </summary>
        ...
        protected override Point3D GetCurrentValueCore(Point3D defaultOriginValue, Point3D defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            Point3D   accumulated = new Point3D();
            Point3D   foundation  = new Point3D();
        ...
        {
            Point3D? typedValue = (Point3D?)value;

            if (typedValue.HasValue)
            {
                return AnimatedTypeHelpers.IsValidAnimationValuePoint3D(typedValue.Value);
            }
            else
            {
                return true;
        ...
        public Point3D? From                
        {
            get
            {
                return (Point3D?)GetValue(FromProperty);
            }
            set
            {
        ...
        public Point3D? To                
        {
            get
            {
                return (Point3D?)GetValue(ToProperty);
            }
            set
            {
        ...
        public Point3D? By                
        {
            get
            {
                return (Point3D?)GetValue(ByProperty);
            }
            set
            {
