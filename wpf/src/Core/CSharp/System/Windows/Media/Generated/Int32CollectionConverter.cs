//---------------------------------------------------------------------------
//
// <copyright file="Int32CollectionConverter.cs" company="Microsoft">
...
{
    /// <summary>
    /// Int32CollectionConverter - Converter class for converting instances of other types to and from Int32Collection instances
    /// </summary>
    public sealed class Int32CollectionConverter : TypeConverter
    {
        ...
        /// <summary>
        /// Attempts to convert to a Int32Collection from the given object.
        /// </summary>
        /// <returns>
        ...
        /// which can be converted to a Int32Collection.
        /// </exception>
        /// <param name="context"> The ITypeDescriptorContext for this call. </param>
        /// <param name="culture"> The requested CultureInfo.  Note that conversion uses "en-US" rather than this parameter. </param>
        /// <param name="value"> The object to convert to an instance of Int32Collection. </param>
        ...
        /// <summary>
        /// ConvertTo - Attempt to convert an instance of Int32Collection to the given type
        /// </summary>
        /// <returns>
        /// The object which was constructoed.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// A NotSupportedException is thrown if "value" is null or not an instance of Int32Collection,
