//---------------------------------------------------------------------------
//
// <copyright file="VectorCollection.cs" company="Microsoft">
...
namespace System.Windows.Media
{
    ...
    public sealed partial class VectorCollection : Freezable, IFormattable, IList, IList<Vector>
    {
        ...
        private Vector Cast(object value)
        {
            ...
            if (!(value is Vector))
            {
                throw new System.ArgumentException(SR.Get(SRID.Collection_BadType, this.GetType().Name, value.GetType().Name, "Vector"));
            }
