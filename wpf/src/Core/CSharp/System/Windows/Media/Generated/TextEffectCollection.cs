//---------------------------------------------------------------------------
//
// <copyright file="TextEffectCollection.cs" company="Microsoft">
...
namespace System.Windows.Media
{
    ...
    public sealed partial class TextEffectCollection : Animatable, IList, IList<TextEffect>
    {
        ...
        /// <summary>
        /// A frozen empty TextEffectCollection.
        /// </summary>
        internal static TextEffectCollection Empty
        {
            get
            {
                if (s_empty == null)
                {
                    TextEffectCollection collection = new TextEffectCollection();
                    collection.Freeze();
                    s_empty = collection;
                }
        ...
        private TextEffect Cast(object value)
        {
            ...
            {
                throw new System.ArgumentException(SR.Get(SRID.Collection_BadType, this.GetType().Name, value.GetType().Name, "TextEffect"));
            }
        ...
        #region Enumerator
        /// <summary>
        /// Enumerates the items in a TextEffectCollection
        /// </summary>
        public struct Enumerator : IEnumerator, IEnumerator<TextEffect>
        {
            #region Constructor
