//---------------------------------------------------------------------------
//
// <copyright file="PathFigureCollectionConverter.cs" company="Microsoft">
...
namespace System.Windows.Media
{
    ...
    public sealed class PathFigureCollectionConverter : TypeConverter
    {
        ...
        /// which can be converted to a PathFigureCollection.
        /// </exception>
        /// <param name="context"> The ITypeDescriptorContext for this call. </param>
        /// <param name="culture"> The requested CultureInfo.  Note that conversion uses "en-US" rather than this parameter. </param>
        /// <param name="value"> The object to convert to an instance of PathFigureCollection. </param>
