//---------------------------------------------------------------------------
//
// <copyright file="BitmapEffectCollection.cs" company="Microsoft">
...
namespace System.Windows.Media.Effects
{
    ...
    public sealed partial class BitmapEffectCollection : Animatable, IList, IList<BitmapEffect>
    {
        ...
        private BitmapEffect Cast(object value)
        {
            ...
            {
                throw new System.ArgumentException(SR.Get(SRID.Collection_BadType, this.GetType().Name, value.GetType().Name, "BitmapEffect"));
            }
