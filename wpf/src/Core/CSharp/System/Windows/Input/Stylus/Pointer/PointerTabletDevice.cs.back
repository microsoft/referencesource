//------------------------------------------------------------------------------
// <copyright file="PointerTabletDevice.cs" company="Microsoft">
...
{  
    ...
    internal class PointerTabletDevice : TabletDeviceBase
    {
        ...
        /// </summary>
        /// <SecurityNote>
        ///     SafeCritical: Calls StylusLogic.CurrentStylusLogic
        ///                   Takes no data and returns the delta, which is safe to expose
        /// </SecurityNote>
        ...
        /// </summary>
        /// <SecurityNote>
        ///     Critical:  Accesses StylusDevice.ActiveSource
        /// </SecurityNote>
