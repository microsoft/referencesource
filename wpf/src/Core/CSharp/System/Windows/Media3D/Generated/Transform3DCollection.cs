//---------------------------------------------------------------------------
//
// <copyright file="Transform3DCollection.cs" company="Microsoft">
...
namespace System.Windows.Media.Media3D
{
    ...
    public sealed partial class Transform3DCollection : Animatable, IList, IList<Transform3D>
    {
        ...
        private Transform3D Cast(object value)
        {
            ...
            {
                throw new System.ArgumentException(SR.Get(SRID.Collection_BadType, this.GetType().Name, value.GetType().Name, "Transform3D"));
            }
