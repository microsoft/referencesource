//---------------------------------------------------------------------------
//
// <copyright file="MatrixTransform3D.cs" company="Microsoft">
...
namespace System.Windows.Media.Media3D
{
    ...
    sealed partial class MatrixTransform3D : Transform3D
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        /// <summary>
        ///     Matrix - Matrix3D.  Default value is Matrix3D.Identity.
        /// </summary>
        ...
        internal override DUCE.ResourceHandle AddRefOnChannelCore(DUCE.Channel channel)
        {
                ...
                if (_duceResource.CreateOrAddRefOnChannel(this, channel, System.Windows.Media.Composition.DUCE.ResourceType.TYPE_MATRIXTRANSFORM3D))
                {
        ...
        /// <summary>
        ///     The DependencyProperty for the MatrixTransform3D.Matrix property.
        /// </summary>
