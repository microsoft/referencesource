//---------------------------------------------------------------------------
//
// <copyright file="Vector3DConverter.cs" company="Microsoft">
...
{
    /// <summary>
    /// Vector3DConverter - Converter class for converting instances of other types to and from Vector3D instances
    /// </summary>
    public sealed class Vector3DConverter : TypeConverter
    {
        ...
        /// <summary>
        /// Attempts to convert to a Vector3D from the given object.
        /// </summary>
        /// <returns>
        /// The Vector3D which was constructed.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// A NotSupportedException is thrown if the example object is null or is not a valid type
        /// which can be converted to a Vector3D.
        /// </exception>
        /// <param name="context"> The ITypeDescriptorContext for this call. </param>
        /// <param name="culture"> The requested CultureInfo.  Note that conversion uses "en-US" rather than this parameter. </param>
        /// <param name="value"> The object to convert to an instance of Vector3D. </param>
        ...
        /// <summary>
        /// ConvertTo - Attempt to convert an instance of Vector3D to the given type
        /// </summary>
        /// <returns>
        /// The object which was constructoed.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// A NotSupportedException is thrown if "value" is null or not an instance of Vector3D,
