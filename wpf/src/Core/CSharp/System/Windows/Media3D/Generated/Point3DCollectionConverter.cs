//---------------------------------------------------------------------------
//
// <copyright file="Point3DCollectionConverter.cs" company="Microsoft">
...
{
    /// <summary>
    /// Point3DCollectionConverter - Converter class for converting instances of other types to and from Point3DCollection instances
    /// </summary>
    public sealed class Point3DCollectionConverter : TypeConverter
    {
        ...
        /// </summary>
        /// <returns>
        /// The Point3DCollection which was constructed.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// A NotSupportedException is thrown if the example object is null or is not a valid type
        /// which can be converted to a Point3DCollection.
        /// </exception>
        /// <param name="context"> The ITypeDescriptorContext for this call. </param>
        ...
        /// <summary>
        /// ConvertTo - Attempt to convert an instance of Point3DCollection to the given type
        /// </summary>
        /// <returns>
        /// The object which was constructoed.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// A NotSupportedException is thrown if "value" is null or not an instance of Point3DCollection,
        /// or if the destinationType isn't one of the valid destination types.
        /// </exception>
        /// <param name="context"> The ITypeDescriptorContext for this call. </param>
        /// <param name="culture"> The CultureInfo which is respected when converting. </param>
        /// <param name="value"> The object to convert to an instance of "destinationType". </param>
        /// <param name="destinationType"> The type to which this will convert the Point3DCollection instance. </param>
