//---------------------------------------------------------------------------
//
// <copyright file="Vector3DCollectionConverter.cs" company="Microsoft">
...
{
    /// <summary>
    /// Vector3DCollectionConverter - Converter class for converting instances of other types to and from Vector3DCollection instances
    /// </summary>
    public sealed class Vector3DCollectionConverter : TypeConverter
    {
        ...
        /// </summary>
        /// <returns>
        /// The Vector3DCollection which was constructed.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// A NotSupportedException is thrown if the example object is null or is not a valid type
        /// which can be converted to a Vector3DCollection.
        /// </exception>
        /// <param name="context"> The ITypeDescriptorContext for this call. </param>
        ...
        /// <summary>
        /// ConvertTo - Attempt to convert an instance of Vector3DCollection to the given type
        /// </summary>
        /// <returns>
        /// The object which was constructoed.
        /// </returns>
        /// <exception cref="NotSupportedException">
        /// A NotSupportedException is thrown if "value" is null or not an instance of Vector3DCollection,
