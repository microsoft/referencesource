...
* Module Name:
*
*   Generic Print Render Target (RT)
*
* Created:
*
*   6/10/2002 fyuan
...
/// <SecurityNote>
/// Critical    - Asserts Registry perimission presubably to get registered codec info
/// </SecurityNote>
[SecurityCritical]
array<Byte>^ GetRawBitmap(BitmapSource ^ pIBitmap, BitmapCodecInfo ^ codec)
{
    ...
    (gcnew RegistryPermission(PermissionState::Unrestricted))->Assert(); //BlessedAssert commen
    try
    {
