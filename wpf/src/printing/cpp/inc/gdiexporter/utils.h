...
// overwritten/garbage.
/// <SecurityNote>
/// Critical: Calls critical Marshal::GetHRForLastWin32Error
/// </SecurityNote>
[SecurityCritical]
...
public:
    ...
    /// <SecurityNote>
    /// Critical    : References method in non-APTCA reachframework.dll (Utility::GetPathPointCount, Utility::GetGeometryDataPointCount)
    /// TreatAsSafe : Utility::GetPathPointCount is safe
    ///                      Utility::GetGeometryDataPointCount is safe
    /// </SecurityNote>
    ...
    /// <SecurityNote>
    /// Critical    : References method in non-APTCA reachframework.dll (Utility::IsRectangle)
    /// TreatAsSafe : ReachFramework method is safe
    /// </SecurityNote>
    [SecuritySafeCritical]
    bool IsRectangle();
