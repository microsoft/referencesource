...
/*++
    ...
    Revision History:                                                           
        ...
        Adina Trufinescu (adinatru) May 24th 2003
--*/
...
namespace Printing
{
    ...
    public PrintSystemObject
    {
        ...
        internal:
        /// <SecurityNote>
        ///    Critical - Instantiates type from non-APTCA reachframework.dll
        ///    Safe 	- Type is safe
        /// <SecurityNote>
        ...
        /// <SecurityNote>
        ///     Critical    : References critical delegates (types from non-APTCA ReachFramework.dll in their signature)
        ...
        ///<SecurityNote>
        /// Critical    - References type from non-APTCA reachframework.dll (PrinterHResult)
