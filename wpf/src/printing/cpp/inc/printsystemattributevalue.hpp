...
/*++
    ...
    Revision History: 
        ...
        Khaled Sedky (khaleds) 1-April-2003
            Added more attributes to cover more printing 
            primitive types
--*/
...
namespace IndexedProperties
{
    ...
    public PrintProperty
    {
        ...
        ///<SecurityNote>
        /// Critical    :   References critical delegate (PrintTicketValueChanged)
        /// TreatAsSafe :   Delegate is critical because its signature contains the safe PrintTicket type from non-APTCA reachframework.dll
        ///                 However the PrintTicket type is safe
        ///</SecurityNote>
        [SecuritySafeCritical]
        PrintTicketProperty(
            String^            attributeName,
        ...
        {
            ///<SecurityNote>
            /// Critical    :   Returns critical delegate (PrintTicketValueChanged)
            /// TreatAsSafe :   Delegate is critical because its signature contains the safe PrintTicket type from non-APTCA reachframework.dll
            ///</SecurityNote>
            [SecuritySafeCritical]
        ...
        ///<SecurityNote>
        /// Critical    :   Sets critical delegate field (of type PrintTicketValueChanged)
        /// TreatAsSafe :   - Delegate is critical because its signature contains type from non-APTCA reachframework.dll (PrintTicket)
	///                   However PrintTicket type is safe.
	///                 - Delegate is set to safe value (null)
        ///</SecurityNote>
        [SecuritySafeCritical]
        virtual
        void
        ...
        ///<SecurityNote>
        /// Critical    :   Field for critical delegate (PrintTicketValueChanged)
        ///</SecurityNote>
        [SecurityCritical]
        PrintSystemDelegates::PrintTicketValueChanged^     changeHandler;       
        
        ///<SecurityNote>
        /// Critical    :   Field for critical type (PrintTicket)
        ///</SecurityNote>
        [SecurityCritical]
        PrintTicket^                                       value;
    };
