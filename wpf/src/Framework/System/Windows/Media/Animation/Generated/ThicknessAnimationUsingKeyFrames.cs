//---------------------------------------------------------------------------
//
// <copyright file="ThicknessAnimationUsingKeyFrames.cs" company="Microsoft">
...
{
    /// <summary>
    /// This class is used to animate a Thickness property value along a set
    /// of key frames.
    /// </summary>
    ...
    public class ThicknessAnimationUsingKeyFrames : ThicknessAnimationBase, IKeyFrameAnimation, IAddChild
    {
        ...
        /// <Summary>
        /// Creates a new KeyFrameThicknessAnimation.
        /// </Summary>
        ...
        /// <summary>
        /// Creates a copy of this KeyFrameThicknessAnimation.
        /// </summary>
            ...
            AnimationClock animationClock)
        {
            ...
            else
            {
                ...
                if (currentResolvedKeyFrameIndex == 0)
                {
                    ...
                    if (IsAdditive)
                    {
                        fromValue = AnimatedTypeHelpers.GetZeroValueThickness(defaultOriginValue);
                    }
                    else
                    {
            ...
            if (IsCumulative)
            {
                ...
                {
                    currentIterationValue = AnimatedTypeHelpers.AddThickness(
                        currentIterationValue,
                        AnimatedTypeHelpers.ScaleThickness(GetResolvedKeyFrameValue(maxKeyFrameIndex), currentRepeat));
                }
            }
        ...
        /// <summary>
        /// Returns the ThicknessKeyFrameCollection used by this KeyFrameThicknessAnimation.
        /// </summary>
        ...
        /// 0.0 there is slightly different behavior between KeyFrameThicknessAnimations
        ...
        private Thickness GetResolvedKeyFrameValue(Int32 resolvedKeyFrameIndex)
        {
        ...
        private ThicknessKeyFrame GetResolvedKeyFrame(Int32 resolvedKeyFrameIndex)
        {
        ...
        {
            Debug.Assert(!_areKeyTimesValid, "KeyFrameThicknessAnimaton.ResolveKeyTimes() shouldn't be called if the key times are already valid.");
        ...
        private void ResolvePacedKeyTimes()
        {
            ...
            do
            {
                if (_keyFrames[index].KeyTime.Type == KeyTimeType.Paced)
                {
                    ...
                    Thickness prevKeyValue = _keyFrames[index - 1].Value;

                    do
                    {
                        Thickness currentKeyValue = _keyFrames[index].Value;

                        // Determine the segment length for this key frame and
                        // add to the total length.
                        totalLength += AnimatedTypeHelpers.GetSegmentLengthThickness(prevKeyValue, currentKeyValue);
                    ...
                    totalLength += AnimatedTypeHelpers.GetSegmentLengthThickness(prevKeyValue, _keyFrames[index].Value);
