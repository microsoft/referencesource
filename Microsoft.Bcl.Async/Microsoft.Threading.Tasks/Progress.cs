// NOTE: Although this looks very similar to the Progress<T> class available in the framework, the reason this is here is due to the lack of ability to make this
// compatible due to EventHandler difference. Note that in 4.0, EventHandler<T> has a constraint on EventArgs, in 4.5 we removed it.
using System;
...
namespace Microsoft
{
    ...
    public class Progress<T> : IProgress<T>
    {
        ...
        protected virtual void OnReport(T value)
        {
            ...
            ProgressEventHandler<T> changedEvent = ProgressChanged;
