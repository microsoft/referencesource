...
namespace System.Windows.Forms.PropertyGridInternal {
    ...
    internal class DocComment : PropertyGrid.SnappableControl {
        ...
        public override int GetOptimalHeight(int width) {
            ...
            g.Dispose();
            var padding = DpiHelper.EnableDpiChangedHighDpiImprovements ? LogicalToDeviceUnits(2) : 2;
            height += (sz.Height * 2) + padding;
            return Math.Max(height + 2 * padding, DpiHelper.EnableDpiChangedHighDpiImprovements ? LogicalToDeviceUnits(CYDEF) : CYDEF);
        }
        ...
        protected override void OnResize(EventArgs e) {
            ...
            if (DpiHelper.EnableDpiChangedHighDpiImprovements) {
                ...
                if (ClientRectangle.Width != rect.Width || ClientRectangle.Height != rect.Height) {
        ...
        private void SetChildLabelsBounds() {
            ...
            m_labelDesc.SetBounds(m_labelDesc.Top,
                                  m_labelDesc.Left,
                                  size.Width,
                                  Math.Max(0, size.Height - lineHeight - (DpiHelper.EnableDpiChangedHighDpiImprovements ? LogicalToDeviceUnits(1) : 1)),
                                  BoundsSpecified.Size);
        }
