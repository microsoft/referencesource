...
namespace System.Net.Http.Headers
{
    public class ContentDispositionHeaderValue : ICloneable
    {
        ...
        public long? Size
        {
            get
            {
                NameValueHeaderValue sizeParameter = NameValueHeaderValue.Find(parameters, size);
                ulong value;
            ...
            set
            {
                ...
                if (value == null)
                {
                    ...
                    if (sizeParameter != null)
                    {
                        ...
                        parameters.Remove(sizeParameter);
                    }
                }
                else if (value < 0)
                {
        ...
        {
            return dispositionType + NameValueHeaderValue.ToString(parameters, ';', true);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return (string.Compare(dispositionType, other.dispositionType, StringComparison.OrdinalIgnoreCase) == 0) &&
        ...
        internal static int GetDispositionTypeLength(string input, int startIndex, out object parsedValue)
        {
            ...
            contentDispositionHeader.dispositionType = dispositionType;
        ...
        // Gets a paramiter of the given name and attempts to extract a date.
        // Returns null if the parameter is not present or the format is incorrect.
        private DateTimeOffset? GetDate(string parameter)
        {
            NameValueHeaderValue dateParameter = NameValueHeaderValue.Find(parameters, parameter);
            DateTimeOffset date;
        ...
        private void SetDate(string parameter, DateTimeOffset? date)
        {
            ...
            if (date == null)
            {
                ...
                {
                    Debug.Assert(parameters != null);
                    parameters.Remove(dateParameter);
                }
            }
            else
            {
        ...
        {
            NameValueHeaderValue nameParameter = NameValueHeaderValue.Find(parameters, parameter);
        ...
        // Add/update the given parameter in the list, encoding if nessisary.
